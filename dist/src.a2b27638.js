...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/alert.mp3":[function(require,module,exports) {
module.exports = "/alert.3ca48bb4.mp3";
},{}],"src/index.js":[function(require,module,exports) {
"use strict";

require("../assets/alert.mp3");

var defaultSession = 1;
var maxTime = defaultSession * 60;
...
function updateTime(time) {
  var newTime = maxTime + time * 60;

  if (newTime > 0 && newTime <= 7200) {
    maxTime = newTime;
    totalTime.innerText = "".concat(maxTime / 60, ":00");
  }
}
...
function reset() {
  ...
  isRunning = false;
  totalTime.innerText = "".concat(defaultSession, ":00");
}
...
function countdownTimer() {
  if (totalRemaining != 0 && isRunning) {
    ...
    progressBar.style.width = "".concat(totalRemaining * 45 / maxTime, "%");
  } else {
    reset();
...
},{"../assets/alert.mp3":"assets/alert.mp3"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
